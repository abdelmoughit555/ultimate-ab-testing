...
try {
  ...
  var dexterProduct = {
    ...
    "variants": expirementSessionVariants.map(function (varaint) {
      return varaint.variant_shopify;
    }),
    "images": shopifyProduct.images.map(function (image) {
      return image.src;
    }),
  ...
  var c = _defineProperty({}, shopifyProduct.id, {
    "eid": "zefzef",
  ...
  var storeDisplayId = "qynxce";
  var html_ids = {
    "product_class": "product-single",
    "variant_selector_class": "selector-wrapper",
    "product_card_class": "product-card",
    "price_class": "price",
    "app_name": "dexter"
  };
  if (_typeof(html_ids) !== undefined) var html_ids;
  !function (t) {
    var e = {};
    ...
    (function (e) {
      ...
      t.exports = r("object" == (typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) && globalThis) || r("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window) || r("object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self) || r("object" == _typeof(e) && e) || Function("return this")();
    }).call(this, r(49));
  }, function (t, e, r) {
    var n = r(0),
        o = r(31),
    ...
    (t.exports = function (t, e, r, c) {
      var u = !!c && !!c.unsafe,
          s = !!c && !!c.enumerable,
          f = !!c && !!c.noTargetGet;
      "function" == typeof r && ("string" != typeof e || i(r, "name") || o(r, "name", e), l(r).source = d.join("string" == typeof e ? e : "")), t !== n ? (u ? !f && t[e] && (s = !0) : delete t[e], s ? t[e] = r : o(t, e, r)) : s ? t[e] = r : a(e, r);
    ...
    t.exports = function (t, e) {
      var r,
          ...
          v = t.global,
          h = t.stat;
      if (r = v ? n : h ? n[_] || c(_, {}) : (n[_] || {}).prototype) for (l in e) {
    ...
    _ && v || (_ = function _(t) {
      ...
      delete b[t];
    }, "process" == u(h) ? n = function n(t) {
      h.nextTick(w(t));
    } : y && y.now ? n = function n(t) {
      y.now(w(t));
    } : m && !f ? (i = (o = new m()).port2, o.port1.onmessage = A, n = s(i.postMessage, i, 1)) : !a.addEventListener || "function" != typeof postMessage || a.importScripts || c(E) || "file:" === p.protocol ? n = "onreadystatechange" in d("script") ? function (t) {
    ...
    c[d] = !0, t.exports = Object.create || function (t, e) {
      var r;
      return null !== t ? (f.prototype = o(t), r = new f(), f.prototype = null, r[d] = t) : r = _2(), void 0 === e ? r : i(r, e);
    };
  }, function (t, e, r) {
    "use strict";
    ...
    var n,
        ...
        d = s("iterator"),
        f = !1;
    [].keys && ("next" in (i = [].keys()) ? (o = a(a(i))) !== Object.prototype && (n = o) : f = !0), null == n && (n = {}), l || u(n, d) || c(n, d, function () {
      return this;
    }), t.exports = {
      IteratorPrototype: n,
    ...
    var n,
      ...
      if (u && !_z.prototype["finally"]) return !0;
      if (C >= 51 && /native code/.test(_z)) return !1;
      ...
      if (!e.notified) {
        ...
        O(function () {
          for (var o = e.value, i = 1 == e.state, a = 0; n.length > a;) {
            ...
            try {
              d ? (i || (2 === e.rejection && et(t, e), e.rejection = 1), !0 === d ? c = o : (_ && _.enter(), c = d(o), _ && (_.exit(), s = !0)), c === l.promise ? p(B("Promise-chain cycle")) : (u = K(c)) ? u.call(c, f, p) : f(c)) : p(o);
            } catch (t) {
              _ && !s && _.exit(), p(t);
            }
          }
        ...
        Q = function Q(t, e, r) {
      var n, o;
      X ? ((n = D.createEvent("Event")).promise = e, n.reason = r, n.initEvent(t, !1, !0), s.dispatchEvent(n)) : n = {
        promise: e,
        reason: r
      ...
      E.call(s, function () {
        var r,
            n = e.value;
        if (tt(e) && (r = I(function () {
          J ? U.emit("unhandledRejection", n, t) : Q("unhandledrejection", t, n);
        }), e.rejection = J || tt(e) ? 2 : 1, r.error)) throw r.value;
      });
    },
        tt = function tt(t) {
    ...
    $ && (_z = function z(t) {
      ...
      fetch: function fetch(t) {
        return S(_z, W.apply(s, arguments));
      }
    }))), c({
      global: !0,
      wrap: !0,
    ...
    (t.exports = function (t, e, r, l, d) {
      ...
      if (d) f = t;else {
        ...
        if (o(p)) {
          for (_ = 0, v = i(t.length); v > _; _++) {
            if ((h = l ? g(n(y = t[_])[0], y[1]) : g(t[_])) && h instanceof s) return h;
          }
      ...
      for (m = f.next; !(y = m.call(f)).done;) {
        if ("object" == _typeof(h = u(f, g, y.value, l)) && h && h instanceof s) return h;
      }
    ...
    x || (n = function n() {
      ...
      m.nextTick(n);
    } : h && !v ? (c = !0, u = document.createTextNode(""), new h(n).observe(u, {
      characterData: !0
    }), a = function a() {
      u.data = c = !c;
    ...
    t.exports = function (t, e, r, l, p, y, g) {
      ...
      if (I && (b = i(I.call(new t())), _ !== Object.prototype && b.next && (d || i(b) === _ || (a ? a(b, _) : "function" != typeof b[h] && u(b, h, m)), c(b, E, !0, !0), d && (f[E] = m))), "values" == p && j && "values" !== j.name && (O = !0, T = function T() {
        return j.call(this);
      }), d && !g || S[h] === T || u(S, h, T), f[e] = T, p) if (x = {
        values: A("values"),
        keys: y ? T : A("keys"),
        entries: A("entries")
      }, g) for (w in x) {
        (v || O || !(w in S)) && s(S, w, x[w]);
      } else n({
        target: e,
        proto: !0,
        forced: v || O
    ...
    function o() {
      return {
        ...
        ct: (t = "", document.cookie && (cart_cookies = document.cookie.split(";").forEach(function (e) {
    ...
    function a(t) {
      ...
      var e,
          ...
          o = JSON.stringify(t),
          a = btoa(o);
      queryParams = ["ed=" + a, "z=" + i], api_url += queryParams.join("&"), e = api_url, (n = new XMLHttpRequest()).open("GET", e, async = !0), n.onload = function (t) {
    ...
    function d(t, e, r) {
      for (var n, o = t.querySelector('[name="quantity"]'), i = document.createNodeIterator(t, NodeFilter.SHOW_ELEMENT, {
        acceptNode: function acceptNode(t) {
          return node_values = r.map(function (e) {
            return t.getAttribute(e);
          }), node_values.push(t.innerText), node_values.some(function (t) {
            return e.includes(t);
          }) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
        }
      }); n = i.nextNode();) {
        "true" === n.getAttribute("data-dexter-label-mutated") || n.contains(o) || -1 !== n.outerHTML.indexOf("data-dexter-label-mutated") || "id" === n.getAttribute("name") || (n.labels && n.labels.forEach(function (t) {
          return t.remove();
        }), n.remove());
      }
    }
    ...
    function f(t, e) {
      for (var r, n = Object.keys(e), o = document.createNodeIterator(t, NodeFilter.SHOW_TEXT, {
        acceptNode: function acceptNode(t) {
    ...
    function p(t, e) {
      classes_selector = "." + e.split(",").join(",."), selector_els = t.querySelectorAll(classes_selector), selector_els.forEach(function (t) {
    ...
    function _(t, e, r) {
      ...
      }), selector = [e, r].map(function (t) {
        return '[value="'.concat(t, '"]');
      }).join(","), t.querySelectorAll(selector).forEach(function (t) {
        !function (t, e) {
    ...
    function h(t, e) {
      for (var r, n = Object.keys(e), o = document.createNodeIterator(t, NodeFilter.SHOW_ELEMENT, {
        acceptNode: function acceptNode(t) {
          return node_values = T.option_value_keys.map(function (e) {
            return t.getAttribute(e);
        ...
        "true" !== r.getAttribute("data-dexter-val-mutated") && (T.option_value_keys.forEach(function (t) {
    ...
    function y(t, e) {
      ...
      if ("true" !== t.getAttribute("data-dexter-processed")) {
        var u = function u() {
          r && (show_price = e["dp_" + e.z], hide_price = e["dp_" + e.z_], v(t, show_price, hide_price, T.price_class)), n && e.variantIdToSelect && _(t, e.variantIdToSelect, e.v2o[e.variantIdToSelect]), c ? (form_el = "FORM" === t.nodeName ? t : t.querySelector('form[action="/cart/add"]'), form_el = form_el || t, form_el && h(form_el, e.v_map), form_el.setAttribute("data-dexter-form-submission", "overwritten")) : (d(t, e.options_to_hide, T.option_value_keys), e.hide_variant_selector || f(t, e.dlmap)), T.empty_variant_option_query_selector && t.querySelectorAll(T.empty_variant_option_query_selector).forEach(function (t) {
            0 === t.childElementCount && (t.style.display = "none");
          }), (e.hide_variant_selector || c) && T.variant_selector_class && (variant_selector_classes = T.variant_selector_class ? "selector-wrapper,radio-wrapper," + T.variant_selector_class : "selector-wrapper,radio-wrapper", p(t, variant_selector_classes)), s(T.dom_html_el);
        };

        t.setAttribute("data-dexter-processed", "true"), 0 == e.pings && (analytics_data = o(), analytics_data.v = e.z, analytics_data.eid = e.eid, a(analytics_data), e.pings += 1), 0 != i ? (setTimeout(u, i), setTimeout(u, i + 500)) : u();
      }
    }
    ...
    function g(t, e, r) {
      ...
      if (n !== T.snapshot[t]) for (var o = 0; o < n.length; o++) {
        e(n[o], r);
      }
      T.snapshot[t] = n;
    }
    ...
    function b(t, e) {
      "true" !== t.getAttribute("data-dexter-handled") && (t.setAttribute("data-dexter-handled", "true"), product_handle = function (t) {
        ...
        return decodeURI(e);
      }(t), product_config = e[product_handle], product_config && (y(t, product_config, replace_price = !0, preselect_variant = !0, delay = T.product_card_delay, remap_variants = T.remap_product_card_variants), T.hide_product_card_variant_selector && T.product_card_variant_selector_class && (var_selector = t.querySelector("." + T.product_card_variant_selector_class), var_selector && (var_selector.style.display = "none")), t.setAttribute("data-dexter-product-handle", product_handle)));
    }
    ...
    function x(t, e) {
      if (t.action.indexOf("/cart/add") > -1 && "true" !== t.getAttribute("data-dexter-handled")) {
        ...
        product_config = e[r], product_config && (r !== T.shopify_product_handle && y(t, product_config, replace_price = !0, preselect_variant = !0, delay = T.main_product_delay), t.setAttribute("data-dexter-product-handle", r));
      }
    }

    function w(t, e) {
      root_el = t, product_el = t.getElementsByClassName(T.product_modal_product_class)[0], t = product_el || t, ["ignore", "processing", "finished"].includes(t.getAttribute("data-dexter-status")) || !r(t) && t.querySelector("[name=id]") && setTimeout(function () {
        t.setAttribute("data-dexter-status", "processing");
        var r = t.getAttribute("data-dexter-product-handle"),
            n = !0;
        if (!r) if (n = !1, form_el = t.getElementsByTagName("form")[0], form_el) for (var o = 0; o < form_el.elements.length && !(r = v2p_[form_el.elements[o].value]); o++) {
          ;
        } else {
        ...
        product_config = e[r], product_config ? (preselect_variant = !n, y(t, product_config, replace_price = !0, preselect_variant = preselect_variant, delay = T.product_modal_delay), t.setAttribute("data-dexter-product-handle", r), t.setAttribute("data-dexter-status", "finished")) : r ? t.setAttribute("data-dexter-status", "ignore") : t.setAttribute("data-dexter-status", "finished");
      }, 500);
    }

    function A(t, e) {
      "true" !== t.getAttribute("data-dexter-handled") && (r(t) || setTimeout(function () {
    ...
    function E() {
      if ("product" === T.page_type && T.product_page_test) {
        ...
        is_variant_mismatch = function (t, e) {
          ...
          for (var r = t.concat().sort(), n = e.concat().sort(), o = 0; o < r.length; o++) {
            if (r[o] !== n[o]) return !0;
          }

          return !1;
        }(T.shopify_variant_ids, t.vids.all), is_variant_mismatch || (product_el = T.product_class ? document.getElementsByClassName(T.product_class)[0] : document.querySelectorAll('form[action="/cart/add"]')[0], y(product_el, t, replace_price = T.update_product_page_price_manually, preselect_variant = !T.redirect, delay = T.main_product_delay, remap_variants = T.remap_main_product_variants));
      }

      mutation_observer = new MutationObserver(function (t) {
        T.product_card_class && T.product_card_class.split(",").forEach(function (t) {
          return g(t, b, cfg_);
        }), "index" === T.page_type && g("form", x, cfg_), T.product_modal_class && T.product_modal_class.split(",").forEach(function (t) {
          return g(t, w, cfg_);
        }), "product" === T.page_type && T.other_variant_selector_classes && T.product_page_test && T.other_variant_selector_classes.split(",").forEach(function (t) {
          return g(t, A, cfg_[T.shopify_product_handle]);
        }), "product" === T.page_type && T.other_variant_selector_ids && T.product_page_test && T.other_variant_selector_ids.split(",").forEach(function (t) {
          w(el = document.getElementById(t)), el && A(el, cfg_[T.shopify_product_handle]);
        });
    ...
    var O,
      ...
      shopify_variant_ids: dexterProduct ? dexterProduct.variants.map(function (t) {
        return String(t.id);
      }) : [],
      out_of_stock_variant_ids: dexterProduct ? dexterProduct.variants.filter(function (t) {
        return !t.available;
      }).map(function (t) {
        return String(t.id);
      }) : [],
    ...
    if (function (t) {
      ...
      var n = {},
        ...
        if (r.z = i, r.z_ = a, r.options_to_hide = [].concat(r.opts[a], r.vids[a]), r.options_to_show = [].concat(r.opts[i], r.vids[i]), r.hide_variant_selector = r.opts.all.includes("Default Title") && 2 === r.opts.all.length, r.hide_variant_selector && T.product_class && T.variant_selector_class) {
        ...
        r.variantIdToSelect = r.vids[a].includes(l) ? r.v2v[l] : l || ("v1" === i ? r.vids.v1[0] : null), r.oosv = [], r.pings = 0, r.rdl_map = function (t) {
          var e = {};
          ...
          return e;
        }(r.dl_map), r.dp_v0 = u(r.dp_v0), r.dp_v1 = u(r.dp_v1), r.v_map = {}, r.vids[a].forEach(function (t) {
          r.v_map[t] = r.v2v[t];
        }), r.o_map = {}, n[r.slug] = r;
      };
    ...
    }(c), "product" === T.page_type && T.shopify_product_handle && Object.keys(cfg_).includes(T.shopify_product_handle)) {
      var I = cfg_[T.shopify_product_handle];
      T.product_page_test = !0, T.redirect && I.variantIdToSelect && I.variantIdToSelect != T.shopify_selected_or_first_available_variant_id && (O = I.variantIdToSelect, (S = new URLSearchParams(window.location.search)).set("variant", O), window.location.search = S), function () {
